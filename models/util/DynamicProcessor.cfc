...
component accessors="true" singleton{
	...
	private any function getEntityMetadata( required entityName, required ormService ){
		if( !variables.entityMetadataCache.keyExists( arguments.entityName ) ){
			lock name="orm.dynamic.metadatacache.#arguments.entityName#" type="exclusive" throwOnTimeout="true" timeout="10"{
				if( !variables.entityMetadataCache.keyExists( arguments.entityName ) ){

					variables.entityMetadataCache[ arguments.entityName ] = arguments.ormService.getEntityMetadata( arguments.entityName );
	...
	private array function getRealPropertyNames( required entityName, required ormService ){
		if( !variables.propertyNamesCache.keyExists( arguments.entityName ) ){
			lock name="orm.dynamic.propertycache.#arguments.entityName#" type="exclusive" throwOnTimeout="true" timeout="10"{
				if( !variables.propertyNamesCache.keyExists( arguments.entityName ) ){
					variables.propertyNamesCache[ arguments.entityName ] = arguments.ormService.getPropertyNames( arguments.entityName );
				}
			}
		}
