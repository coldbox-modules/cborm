...
component singleton extends="cborm.models.criterion.Restrictions" {
	...
	Subqueries function init( required criteria ){
		...
		variables.subqueries       = createObject(
			"java",
