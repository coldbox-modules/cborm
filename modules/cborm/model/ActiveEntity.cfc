...
*/
component extends="cborm.model.VirtualEntityService" accessors="true"{
	...
	*/
	function init(string queryCacheRegion, boolean useQueryCaching,	boolean eventHandling, boolean useTransactions,	boolean defaultAsQuery){
		...
		// datasource
		arguments.datasource = new cborm.model.util.ORMUtilFactory().getORMUtil().getEntityDatasource( this );
