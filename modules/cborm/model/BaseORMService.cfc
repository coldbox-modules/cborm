...
component accessors="true"{
	...
	*/
	...
	BaseORMService function init(
		...
		variables.ORM = new cborm.model.util.ORMUtilFactory().getORMUtil();
		// Create the service ORM Event Handler
		variables.ORMEventHandler = new cborm.model.EventHandler();
		...
		variables.restrictions  = new cborm.model.criterion.Restrictions();
	...
	*/
	any function createService(required string entityName,
		...
		return new cborm.model.VirtualEntityService( argumentCollection=arguments );
	}
