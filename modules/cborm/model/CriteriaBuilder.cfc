...
this.RESTRICTIONS - Maps to our ColdBox restrictions class: cborm.model.criterion.Restrictions
...
*/
import cborm.model.*;
component accessors="true" extends="cborm.model.BaseBuilder" {
	...
	*/
	...
	any function onMissingMethod(required string missingMethodName, required struct missingMethodArguments) {
		...
		switch( getMetaData( r ).name ) {
			...
			case 'cborm.model.CriteriaBuilder':
				break;
